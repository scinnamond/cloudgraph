...
public class Stress {
    ...
    private static OptionParser defaultParser() {
        OptionParser parser = new OptionParser() {{
            ...
            accepts("n", "Number of requests to perform (default: 5)").withRequiredArg().ofType(Integer.class);
            ...
            accepts("ip", "The hosts ip to connect to").withRequiredArg().ofType(String.class).defaultsTo("u16551142.onlinehome-server.com");
