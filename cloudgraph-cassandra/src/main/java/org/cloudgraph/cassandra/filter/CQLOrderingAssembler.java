...
public class CQLOrderingAssembler extends DefaultQueryVisitor
    implements QueryConstants 
{
    private static Log log = LogFactory.getLog(CQLOrderingAssembler.class);
	...
	private CQLOrderingAssembler() {}

    public CQLOrderingAssembler(OrderBy orderby,
    ...
    {                
        ...
        if (functions == null || functions.size() == 0) {
            ...
            throw new GraphServiceException("functions not currently supported in CQL");
        }                       
