...
public class CQLFilterAssembler extends SQLQueryFilterAssembler
    implements QueryConstants, FilterAssembler 
{
    ...
    public CQLFilterAssembler(Where where,
        Type contextType)
    {
        super(contextType);
    ...
    /* (non-Javadoc)
	 * @see org.cloudgraph.cassandra.cql.FilterAssembler#getVariableDeclarations()
	 */
    @Override
	public String getVariableDeclarations() { return variableDecls.toString(); }
    /* (non-Javadoc)
	 * @see org.cloudgraph.cassandra.cql.FilterAssembler#hasVariableDeclarations()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.cloudgraph.cassandra.cql.FilterAssembler#getImportDeclarations()
	 */
    @Override
	public String getImportDeclarations() { return importDecls; }
    /* (non-Javadoc)
	 * @see org.cloudgraph.cassandra.cql.FilterAssembler#hasImportDeclarations()
	 */
    @Override
    ...
    /* (non-Javadoc)
	 * @see org.cloudgraph.cassandra.cql.FilterAssembler#getParameterDeclarations()
	 */
    @Override
	public String getParameterDeclarations() { return parameterDecls; }
    /* (non-Javadoc)
	 * @see org.cloudgraph.cassandra.cql.FilterAssembler#hasParameterDeclarations()
	 */
    @Override
