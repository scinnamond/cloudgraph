 ...
 */
public class GraphMutatorReducer<KEYIN, VALUEIN, KEYOUT>
extends GraphReducer<KEYIN, VALUEIN, KEYOUT> implements GraphMutator, GraphAccessor {
	
    private static Log log = LogFactory.getLog(GraphMutatorReducer.class);
    private ServiceContext context;
	
	public GraphMutatorReducer() {
    	try {
