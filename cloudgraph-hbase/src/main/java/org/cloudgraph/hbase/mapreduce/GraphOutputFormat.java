 ...
 */
public class GraphOutputFormat<KEY> extends OutputFormat<KEY, Writable>
		implements Configurable {

	private final Log LOG = LogFactory.getLog(GraphOutputFormat.class);
	 ...
	 *            The type of the key.
	 */
	protected static class TableRecordWriter<KEY> extends
			RecordWriter<KEY, Writable> {
	...
	public void setConf(Configuration otherConf) {
		...
		try {
			...
			this.table = HBaseConnectionManager.instance().getConnection(
					tableName);
