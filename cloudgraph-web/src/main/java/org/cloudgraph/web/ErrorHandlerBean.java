...
{                                    
    ...
    public String getErrorType()
    {
    	try {
	        if (throwable != null)
	        {
	            if (throwable instanceof org.plasma.common.exception.UserException)
	            {
	            	org.plasma.common.exception.UserException userException = (org.plasma.common.exception.UserException)throwable;
