...
public class GraphTreeAssembler implements PlasmaDataGraphVisitor 
{
    private static Log log = LogFactory.getLog(GraphTreeAssembler.class);
	...
	public GraphTreeAssembler() {
		this.typeMap = new DefaultTreeNodeTypeMap();
	}
	
	public GraphTreeAssembler(TreeNodeTypeMap typeMap) {
