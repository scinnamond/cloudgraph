...
<h:panelGrid id="catz_panel" columns="1" width="100%" border="0">
    <h:dataTable id="inst_tax_table" width="95%" border="0"
        var="tax" value="#{InstanceEditBean.taxonomies}">
 	    <h:column>
 	        <rich:dataTable 
 	            id="tax_sub_table"
	          ...
	          <rich:column
                  ...
                  <a4j:commandLink id="edit_catz_link" 
                      ...
                      <f:setPropertyActionListener value="#{InstanceEditBean.clazzDataObject}"   
                      ...
                      <f:setPropertyActionListener value="inst_tax_table"   
		   ...
		   <h:panelGrid columns="2" width="10%" border="0">
               <a4j:commandButton 
			        ...
			        oncomplete="#{rich:component('createEditCategorizationPanel')}.show()"
			        reRender="createEditCategorizationForm">
			        <f:setPropertyActionListener value="#{InstanceEditBean.instanceDataObject}"   
				            target="#{CategorizationEditBean.target}" />                      	                    
                    <f:setPropertyActionListener value="#{tax}"   
                            target="#{CategorizationEditBean.taxonomy}" />                                           
			        <f:setPropertyActionListener value="inst_tax_table"   
