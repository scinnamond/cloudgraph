...
<%@ taglib uri="http://java.sun.com/jsf/html"   prefix="h" %>
  ...
  <t:dataTable id="rqstd_prj_dtbl" var="project" value="#{RequestedProjectQueueBean.results}"                                                                       
    preserveDataModel="true" width="100%" align="center" rows="15" preserveSort="true"                                                       
    sortColumn="#{RequestedProjectQueueBean.sortBy}"                                                                                                     
    sortAscending="#{RequestedProjectQueueBean.ascending}"                                                                                               
   ...
   <t:column>                                                                                                                               
      <f:facet name="header">                                                                                                               
        <t:commandSortHeader columnName="currentRevision">                                                                                           
          <f:facet name="ascending">                                                                                                        
          <h:graphicImage value="/images/sort_ascending.gif" rendered="true" alt="Sort Ascending" border="0"/>                              
          </f:facet>                                                                                                                        
          <f:facet name="descending">                                                                                                       
   ...
   <h:column id="actionsColumn">                                                                                                                              
        ...
        <f:verbatim>&nbsp</f:verbatim>                   
        <a4j:commandLink action="#{ProjectEditBean.revise}"
            actionListener="#{RequestedProjectQueueBean.refresh}"
            title="Create and edit a new revision for this project">                                                                               
