...
<h:panelGrid id="perspectives_panel" columns="1" width="100%" border="0">
    <h:dataTable id="perspective_table" width="95%" border="0"
        var="tax" value="#{PropertyEditBean.perspectives}">
 	    <h:column>
 	        <rich:dataTable 
 	            id="tax_sub_table"
	          ...
	          <rich:column
                  ...
                  <a4j:commandLink id="edit_catz_link" 
                      ...
                      <f:setPropertyActionListener value="#{PropertyEditBean.propertyDataObject}"   
                      ...
                      <f:setPropertyActionListener value="perspective_table"   
