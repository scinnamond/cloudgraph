...
<h:panelGrid id="catz_panel" columns="1" width="100%" border="0">
    <h:dataTable id="taxonomy_table" width="95%" border="0"
        var="tax" value="#{PropertyEditBean.taxonomies}">
 	    <h:column>
 	        <rich:dataTable 
 	            id="tax_sub_table"
	          ...
	          <rich:column
                  ...
                  <a4j:commandLink id="edit_catz_link" 
                      ...
                      <f:setPropertyActionListener value="taxonomy_table"   
