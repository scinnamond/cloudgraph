...
public class GraphXmlRecordReader extends
	...
	/**
	 * Deserializes the given text/xml and unmarshalles it as a data graph, capturing various
	...
	private DataGraph unmarshal(Text text) throws IOException {
    	...
    	long before = System.currentTimeMillis();
     	...
     	ByteArrayInputStream xmlloadis = new ByteArrayInputStream(text.getBytes());
     	try {
