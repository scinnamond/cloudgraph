...
@Deprecated
public class OldGraphAssembler extends JDBCSupport
    implements LangStoreGraphAssembler {

    private static Log log = LogFactory.getLog(OldGraphAssembler.class);
	...
	private OldGraphAssembler() {}
	
	public OldGraphAssembler(PlasmaType rootType,
	...
	private void assemble(PlasmaType targetType, PlasmaDataObject source, PlasmaProperty sourceProperty, 
		...
		if (where == null) {        
			...
			RDBFilterAssembler filterAssembler = new RDBFilterAssembler(where, 
					targetType, aliasMap);
			List<Object> params = new ArrayList<Object>();			
